...
// import { getcss } from "../../assets/utils/getcss";
...
export default function Header({ colored = true }: HeaderProps) {
  const colorclass = colored
    ? svgstyle.primatycolorfill
    : svgstyle.textcolorfill;
  return (
    <div className={styles.container}>
      ...
      <svg x="0px" y="0px" height="100%" viewBox="0 0 513.29 101.12">
        <rect
          ...
          width="9.71"
          height="14.04"
          className={svgstyle.textcolorfill}
        />
        <rect
          x="310.96"
          y="91.41"
	...
	S336.49,3.77,315.08,3.77z"
        ...
        <g>
          <g>
            ...
            />
            <path
              d="M242.23,40.52h19.46v6.79h-19.46V40.52z"
              className={svgstyle.textcolorfill}
            />
          </g>
        </g>
        ...
        <g>
          <g>
            <path
              d="M366.75,40.52h19.46v6.79h-19.46V40.52z"
              className={svgstyle.textcolorfill}
            />
            <path
